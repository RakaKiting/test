        ...
        <div align="center">
            <form name="form-login" method="POST" action="login.php">
                <table width="310" border="0" cellpadding="0" cellspacing="0">
                    <tr bgcolor="blue">
                        <td height="25" colspan="2" align="center"><font color="#FFFFFF">Halaman Login Penjualan</font></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td height="18" align="right">ID : </td>
                        <td><input type="text" name="id_user" size="20" maxlength="9"></td>
                    </tr>
                    <tr>
                        <td> </td>
                        <td> </td>
                    ...
                    <tr>
                        ...
                        <td><input type="password" name="password_user" size="20"></td>
                    </tr>
                    <tr>
                        <td height="16"> </td>
                        <td> </td>
